...
## Requirements
- **The Stack:** you must use Python as the primary stack (e.g. FastAPI in back, Python-served frontend UI).
...
- **Developer Experience Matters:** make it incredibly easy for us to get your app running (e.g. a single command to start the Python app and UI).
